    ...
    try {
      ...
      this.transport = new StdioClientTransport({
        ...
        env: {
          ...
          URU_PROXY_URL: this.useLocal ? 'http://localhost:3001' : 'https://mcp.uruintelligence.com'
        },
        stderr: 'pipe'
      });
    ...
    try {
      ...
      if (emailTool) {
        ...
        const emailParams = {
          ...
          from: 'noreply@uruintelligence.com'
        };
...
async function runTests(key, options = {}) {
  ...
  try {
    ...
    console.log(chalk.cyan(`🌐 Proxy URL: ${options.local ? 'http://localhost:3001' : 'https://mcp.uruintelligence.com'}\n`));
