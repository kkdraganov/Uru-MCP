...
function checkNodeVersion() {
  ...
  if (majorVersion < 18) {
    console.warn(chalk.yellow('⚠️  Warning: Node.js 18+ is recommended. You have:'), nodeVersion);
    return false;
  }
...
function showClaudeDesktopInfo() {
  ...
  console.log(chalk.green.bold('🖥️  Claude Desktop Integration:'));
  console.log();
...
function showTroubleshooting() {
  ...
  console.log(chalk.gray('• Tools not appearing: Check Claude Desktop configuration'));
  console.log();
