  ...
  static analyzeError(error, context) {
    ...
    if (error.code === 'ECONNREFUSED') {
      ...
      result.suggestions = [
        ...
        'Run: npx uru-mcp --setup to reconfigure'
      ];
    ...
    // Configuration errors
      ...
      result.suggestions = [
        'Run: npx uru-mcp --setup to configure',
        'Set the URU_API_KEY environment variable',
        'Use the --key command line option'
      ];
    }
    ...
    // MCP-specific errors
      ...
      result.suggestions = [
        ...
        'Run: npx uru-mcp --claude-config for setup help'
      ];
    }
  ...
  static createUserError(type, details = {}) {
    const errors = {
      'missing-config': {
        ...
        suggestions: [
          'Run: npx uru-mcp --setup',
          'Set the URU_API_KEY environment variable',
          'Use command line options (--proxy-url, --key)'
        ]
      },
      'invalid-url': {
        ...
        suggestions: [
          ...
          'Check for typos in the URL',
          'Example: https://mcp.uruintelligence.com'
        ]
      },
      'connection-failed': {
